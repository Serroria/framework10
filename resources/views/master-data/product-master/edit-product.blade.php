                        ...
                        <form action="{{ route('product-update', $product->id)}}" method="POST" class="p-6 bg-white rounded shadow-md">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="product_name" name="product_name"
                                    value="{{ old('product_name', $product->product_name) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div class="mb-4">
                                <label for="unit" class="block font-mediumtext-gray-700">Unit:</label>
                            ...
                            <div class="mb-4">
                                <label for="type" class="block font-mediumtext-gray-700">Type:</label>
                                <input type="text" id="type" name="type" value="{{ old('type', $product->type) }}" required class="w-fullp-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div class="mb-4">
                                <label for="information" class="block font-text-gray-700">Information:</label>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" id="producer" name="producer"
                                    value="{{ old('producer', $product->producer) }}" required class="w-full p-2 mt-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div class="flex justify-end">
                                <button type="submit" class="px-4 py-2 text-white bg-indigo-500 rounded hover:bg-indigo-600 focus:ring-2focus:ring-indigo-500">Update Product</button>
                            </div>
                        </form>
                    </div>
                </div>
